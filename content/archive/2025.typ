...
#show: main.with(
  ...
  articles: (
    ...
    (title: "使用 Cloudflare D1 与 Astro 为博客添加评论功能", date: "2025-08-30", path: "/content/article/tutorials/2025/cloudflare-d1-comments.typ"),
    (title: "在编译 NBIS 时强制使用小端序", date: "2025-09-14", path: "/content/article/tutorials/2025/nbis-little-endian.typ"),
